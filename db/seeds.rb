...
user1.events.create([
  {title: "テスト", description: "テスト", start_date: "2021-06-24 00:00:00", end_date: "2021-06-25 00:00:00", official_page: "", image: nil, location: "テスト", latitude: 35.68308, longitude: 139.685805, category_ids:[1,2]},
  ...
  {title: "夜のすいぞくかん", description: "暗くなった水槽で、生きものたちの様子をじっくり観察できる。さらに、博多湾のきれいな夜景をバックにジャンプする「夜のイルカショー」も。\r\n\r\n営業時間 9時30分〜21時まで（最終入館20時まで）", start_date: "2021-07-28 15:00:00", end_date: "2021-08-30 15:00:00", official_page: "https://marine-world.jp/whats-new/events/event_66/", image: nil, location: "福岡市東区西戸崎18-28　マリンワールド海の中道", latitude: 33.661212, longitude: 130.363365, category_ids:[4,6,9]},

  {title: "大人のかき氷", description: "表参道ヒルズのお店が「TRIP」をテーマに、様々な国や街をイメージしたかき氷を揃えた、毎年恒例「大人のかき氷」を開催！\r\n#かき氷", start_date: "2021-08-03 15:00:00", end_date: "2021-08-10 15:00:00", official_page: "https://www.omotesandohills.com/sp/shavedice/", image: open("./db/image/d72321-3-342862-20.jpg"), location: "表参道ヒルズ", latitude: 35.667225, longitude: 139.708796, category_ids:[3,10]},
  ...
  {title: "わくわく！ウォーターガーデン", description: "障害物のあるアスレチックアトラクション「ホエールアドベンチャー」をはじめ、大好評のストレートとカーブのウォータースライダー「ざぶ～んダブルスライダー」､ふわふわの泡で遊ぶ「あわあわホイップ」など、ミストシャワーが湧きでる涼しい空間で、水に濡れながら楽しく元気に遊ぶことのできる4つのアトラクションを展開！\r\n\r\n", start_date: "2021-07-16 15:00:00", end_date: "2021-09-11 15:00:00", official_page: "https://at-raku.com/event/wakuwaku_watergarden/", image: nil, location: "東京ドームシティアトラクションズ", latitude: 35.704278, longitude: 139.754268, category_ids:[6,9]},

  {title: "イケセイアイスパーク", description: "デパ地下の特設会場にて「イケセイアイスパーク」を開設、かき氷やジェラートなどが週替わりで登場。初登場のイタリアンかき氷や老舗肉問屋が作る102年の歴史が生んだかき氷など、のべ15店舗の味が楽しめる。\r\n#かき氷", start_date: "2021-08-28 15:00:00", end_date: "2021-08-30 15:00:00", official_page: "https://ignite.jp/2021/07/287637/", image: nil, location: "西武池袋本店", latitude: 35.728825, longitude: 139.711664, category_ids:[3,10] }
])
